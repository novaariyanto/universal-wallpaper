            ...
            <div class="row">
             	<div class="col-md-6">
            		<div class="form-group">
						...
						$wname  =$wallpaper->wallpaper_name; 
						$wallpapername = ($wname!= "")?$wname:generateRandomString();
						echo form_input( array(
							'name' => 'wallpaper_name',
							'value' => set_value( 'wallpaper_name', $wallpapername, false ),
					...
					<div class="form-group">
						...
						<select class="form-control" name="types" id="types">
							...
							<?php
								echo '<option value="1" selected>Free</option>';
					...
					<div class="form-group">
						...
						<select class="form-control" name="image_type_por_hor" id="image_type_por_hor">
							<option value="0">Type Scale</option>
							<option value="2" selected>Portrait</option>
							<?php
								// echo '<option value="1" selected>Free</option>';
							$array = array( 'Lanscape' => 1,'square'=>3);
...
<!-- 
					...
					<label>
						...
						<div class="form-group" style="padding-top: 30px;">
							<div>
						        <label><input type="radio" checked="" name="wallpaperRadio" value="is_wallpaper" <?php 
						    ...
						    <div class="is_wallpaper box" style="display: <?php echo $display; ?> "> 
								...
								<?php if ( !isset( $wallpaper )): ?>
									...
									<div class="form-group">
										...
										<input type="text" name="images1" id="images1">	
										...
										<div class="col-md-4" style="height:100">
											...
											<div class="thumbnail">
												...
												<a  href="<?php echo $this->ps_image->upload_url . $img->img_path; ?>">
													<img style="width: <?php echo $width ?>;height: <?php echo $height ?>;" src="<?php echo  $img->img_path ?>">
												</a>
											<?php } ?>
												<br/>
                ...
                <div class="col-md-6">
					...
					<div class="form-group">
                  	...
                  	<div class="form-group">
						...
						<?php
						$search_tag = (show_data( @$wallpaper->wallpaper_search_tags )=="")?'Google Search Consolse':show_data( @$wallpaper->wallpaper_search_tags);

						echo form_input( array(
							'name' => 'wallpaper_search_tags',
							'value' => set_value( 'wallpaper_search_tags', $search_tag , false ),
							'class' => 'form-control form-control-sm',
					...
					<div class="form-group">
						<div class="form-check">
							...
							<?php echo form_checkbox( array(
								...
								'value' => 'accept',
								'checked' => set_checkbox('wallpaper_is_published', 1, true),
