...
class BE_Controller extends PS_Controller {
	...
	function replace_cover_photo( $img_type, $id )
	{
		 ...
		 * Insert New Image
		 */
		if ( ! $this->insert_images( $files_url, $img_type, $id,$image_type_por_hor )) {
		// if error in saving image
	 ...
	 */
	// get_images( $files, $img_type, $img_parent_id )
	function insert_images($files_url, $img_type, $img_parent_id,$image_type_por_hor){
		 
		if ($image_type_por_hor == 1) {
			$width = 9;
			$height = 6;
		} else if ($image_type_por_hor == 2) { 
			$width = 6;
			$height = 9;
		} else if ($image_type_por_hor == 3) {
			$width = 6;
			$height = 6;
		}
	...
	function insert_images2( $files, $img_type, $img_parent_id )
	{
